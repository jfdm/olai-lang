...
namespace Olai
  public export
  data Error : Type where
    Generic : String -> Olai.Error
    Opts    : Options.Error -> Olai.Error
    Lex     : Lexing.Error -> Olai.Error
    Parse   : Parsing.Error -> Olai.Error
    TyCheck : Generic.Error Typing.Error -> Olai.Error
    Exec    : Running.Error -> Olai.Error
